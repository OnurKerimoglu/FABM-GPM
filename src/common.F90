...
module gpm_common
   ...
   real(rk), parameter :: TINYPREYC =1.0e-1    ! the minimum prey-C concentration [mmolC/m3] detectable by predators
...
!     Model parameters
   ...
   type (type_bulk_standard_variable),parameter :: total_NPPR = type_bulk_standard_variable(name='total_NPPR',units='mmolC/m^3/d',aggregate_variable=.true.)
