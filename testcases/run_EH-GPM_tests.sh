...
rootdir='2019_05_21_odemet2_n20_2013'
run=1
...
if [ $v == 1 ]; then
 ...
 if [ $run == 1 ]; then
  ...
  python plot_1D-EH-GPM.py 1D-40m_GPM-EH_fixstochl_dm.nc 1 1 3
 ...
 if [ $run == 1 ]; then
  ...
  python plot_1D-EH-GPM.py 1D-40m_GPM-EH_fixsto_empchl_dm.nc 1 1 3
 ...
 if [ $run == 1 ]; then
  ...
  python plot_1D-EH-GPM.py 1D-40m_GPM-EH_varsto_dm.nc 1 1 3
